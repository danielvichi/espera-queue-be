...
describe('ClientService', () => {
  ...
  describe('disableClient', () => {
    it('should disable an existing enabled client', async () => {
      ...
      const disabledClient = await clientService.disableClient(
        existingClient.id,
      );
  ...
  describe('enableClient', () => {
    it('should re-enable a disabled client', async () => {
      ...
      const reEnabledClient = await clientService.enableClient(
        disabledClient.id,
      );
  ...
  describe('deleteClient', () => {
    describe('deleteClient', () => {
      it('should NOT be able to DELETE a client without an existing id', async () => {
        ...
        await expect(
          clientService.deleteClient(invalidClientId),
        ).rejects.toThrow(new ClientNotFoundException(invalidClientId));
      });
